...
#define GAME_LEVEL_WIDTH 7 //amount of tiles in width on the game screen
#define GAME_LEVEL_HEIGHT 5 //amount of tiles in height on the game screen

#define TILESIZE 150 //amount of pixels in grid tile side
//TODO move to classes as constants?
#define TOWER_SPRITE_SIZE TILESIZE
#define ENEMY_SPRITE_SIZE 100
